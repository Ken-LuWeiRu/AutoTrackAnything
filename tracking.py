...
if __name__ == '__main__':
    ...
    try: 
        ...
        yolov8pose_model = Yolov8PoseModel(DEVICE, PERSON_CONF)
        ...
        with torch.cuda.amp.autocast(enabled=True):
            ...
            while (cap.isOpened()):
                ...
                if current_frame_index % args.yolo_every == 0:
                    yolo_filtered_bboxes = yolov8pose_model.get_filtered_bboxes_by_confidence(
                        frame)
        ...
        if args.output_video_path is not None and 'result' in locals():
            result.release()
